        ...
        if (data.msg == 'Thêm vào mục yêu thích thành công') {
          ...
          state.favoritesData = [
            ...state.favoritesData,
            {
              ...
              image:
                data.data?.detailTours[0].images.linkImage[0] ||
                'https://tse4.mm.bing.net/th?id=OIP.1zq4a7G007iHUBybiLxrTwAAAA&pid=Api&P=0&h=220',
              tourName:
                data.data?.detailTours[0].tourName ||
                'Khám Phá trải nghiệm tham quan Phố cổ Hội An',
              price: data.data?.detailTours[0].details[0].priceAdult || 100000,
              locate:
                data.data?.detailTours[0].locations.destination || 'Nghệ An',
            },
          ];
        }
      })
      ...
      .addCase(LayDanhSachYeuThich.fulfilled, (state, action) => {
        ...
        state.favoritesData = action.payload.map(item => ({
          ...
          image:
            ...
            'https://tse4.mm.bing.net/th?id=OIP.1zq4a7G007iHUBybiLxrTwAAAA&pid=Api&P=0&h=220',
          tourName:
            item?.tourName || 'Khám Phá trải nghiệm tham quan Phố cổ Hội An',
