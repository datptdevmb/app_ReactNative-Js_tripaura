...
const ChonVoucher = ({navigation, route}) => {
  ...
  const {getVoucherData, getVoucherStatus} = useSelector(
    state => state.reducer.vouchers,
  );
      ...
      <TouchableOpacity
        ...
        <View
          style={[
            ...
            totalPrice < item.voucherId.condition && {backgroundColor: 'grey'},
          ]}>
          <View
            style={{
              width: 100,
          ...
          <View>
            ...
            <Text style={styles.itemPrice}>
              Thời hạn: {formatDate(item.voucherId.endDay)}{' '}
            </Text>
          </View>
        </View>
      </TouchableOpacity>
      ...
      {getVoucherData.code === 200 ? (
        ...
        <View
          ...
          <Image
            ...
            source={require('../../../assets/icons/voucherNodata.png')}
          />
          <Text
            style={{
              fontSize: 15,
            ...
            Không có voucher vui lòng thử lại sau
          </Text>
        </View>
      )}
    </View>
