...
const OrderReviewScreen = ({ navigation, route }) => {
  ...
  const { detailId, adultPrice, childPrice, discount, voucherId } = route.params;
  const image = tourById?.imges ? tourById.imges[0] : null;
  const tourName = tourById?.tourName;
      ...
      <View style={styles.container}>
          ...
          <ScrollView>
              <View style={styles.content}>
                  ...
                  <Paymethod selectedMethod={selectedMethod} setSelectedMethod={setSelectedMethod} />
